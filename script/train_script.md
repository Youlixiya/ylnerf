...
```shell
#lego
python3 train.py --root_dir data/nerf_synthetic/lego --dataset_name blender --img_wh 400 400 --batch_size 4096 --num_epochs 20 --exp_name lego --workers 16 --use_wandb --project_name nerf_lego --devices 4
```
# eval script
```shell
